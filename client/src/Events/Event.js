      ...
      <div class="card shadow-sm p-3bg-white rounded">
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between">
            ...
            <div>
              <span class="text-secondary">Begin: </span>
          ...
          {!show ? (
            <div>
              <div class="d-flex justify-content-between">
                <div>
                  ...
                  <span class="text-danger">{numMember}</span>{" "}
            ...
            <div>
              <div>
                <span class="text-secondary">So luong: </span>{" "}
                <span class="text-danger">{numMember}</span>{" "}
                <span class="text-secondary"> nguoi</span>
              </div>
              <div>
                <span class="text-secondary">Address: </span>{" "}
                {props.item.address}{" "}
              </div>
              <p class="card-text mt-2">Description:{props.item.description}</p>
              <div class=" mb-2">
